...
EXCLUDE_PREFIXES = (
    ...
    "include/linux/timerqueue.h",
    "lib/timerqueue.c",
    # Display subsystem (keep Qualcomm MSM DRM display pipeline 100% atomic with 4.14.186)
    "drivers/gpu/",
    "include/drm/",
    "include/uapi/drm/",
    "include/video/",
    # Storage subsystem (keep Qualcomm eMMC / MMC block driver 100% atomic with 4.14.186)
    "drivers/mmc/",
    "include/linux/mmc/",
    "include/uapi/linux/mmc/",
    # Device mapper & dm-verity (keep dm-verity and device-mapper 100% atomic with 4.14.186)
    "drivers/md/",
    "include/linux/device-mapper.h",
    # Filesystem subsystem (keep ext4, f2fs, erofs, proc, sysfs, fscrypt 100% atomic with 4.14.186)
    "fs/",
    "include/linux/fs.h",
    ...
    # Memory management subsystem (keep page_alloc, mmap, rmap, and OPPO multi_freearea 100% atomic with 4.14.186)
    "mm/",
    "include/linux/mm.h",
