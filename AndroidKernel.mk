...
#add for unset SECURITY_SELINUX_DEVELOP, set it only for debug
ifneq ($(OBSOLETE_KEEP_ADB_SECURE),1)
KERNEL_CONFIG_OVERRIDE := CONFIG_SECURITY_SELINUX_DEVELOP=y
endif
ifeq ($(EUCLID_BUILD_INSECURE_KERNEL),1)
KERNEL_CONFIG_OVERRIDE := CONFIG_SECURITY_SELINUX_DEVELOP=y
endif
