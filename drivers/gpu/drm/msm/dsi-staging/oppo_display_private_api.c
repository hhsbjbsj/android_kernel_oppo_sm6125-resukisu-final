...
{
	return (((get_project() == 19021) || (get_project() == 19022) || (get_project() == 19026) || (get_project() == 19027) || (get_project() == 19028) ||\
	         (get_project() == 19029) || (get_project() == 19321) || (get_project() == 19322) || (get_project() == 19323) || (get_project() == 19325) ||\
	         (get_project() == 19326) || (get_project() == 19327) || (get_project() == 19328) || (get_project() == 19329) || (get_project() == 19340) ||\
	         (get_project() == 19341) || (get_project() == 19342) || (get_project() == 19343)) ? 1 : 0);
}
...
/* modify aod brightness when aod force to gpu compositon */
...
/*cabc node - /sys/kernel/oppo_display/LCM_CABC-----begin*/
int cabc_mode = 1;
...
/*cabc node - /sys/kernel/oppo_display/LCM_CABC-----end*/
